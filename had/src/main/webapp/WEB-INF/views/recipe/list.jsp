    ...
    <div id="wrap">
        ...
        <div id="search">
            <form method="GET" action="/recipe/search">
                ...
                <div>
                    <input type="text" name="keyword" value="${pager.keyword}" placeholder="이름 or 재료 검색">
                    <button id="search_btn"><img src="${pageContext.request.contextPath}/resources/img/search.png"></button>
                </div>
            </form>
        </div>
        <div id="menu_nav">
